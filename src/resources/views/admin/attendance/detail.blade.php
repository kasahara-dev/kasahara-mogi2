...
@section('content')
    <div class="container">
        <form action="/admin/attendance/{{ $attendanceId }}" method="post">
            @method('PUT')
            @csrf
            ...
            @foreach ($rests as $key => $rest)
                <div class="list-line">
                    ...
                    <dd class="list-line-data">
                        <div class="list-line-selectors-area">
                            <div class="list-line-time">
                                <select name="rest_start_hour[{{ $key + 1 }}]" id="rest_start_hour_{{ $key + 1 }}" class="list-line-selector">
                                ...
                                :
                                <select name="rest_start_minute[{{ $key + 1 }}]" id="rest_start_minute_{{ $key + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 59; $i++)
                                        <option value="{{ $i }}"
                            ...
                            <p class="list-line-wave">～</p>
                            <div class="list-line-time">
                                <select name="rest_end_hour[{{ $key + 1 }}]" id="rest_end_hour_{{ $key + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 24; $i++)
                                        <option value="{{ $i }}"
                                ...
                                :
                                <select name="rest_end_minute[{{ $key + 1 }}]" id="rest_end_minute_{{ $key + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 59; $i++)
                                        <option value="{{ $i }}"
            ...
            @endforeach
                <div class="list-line">
                    ...
                    <dd class="list-line-data">
                        <div class="list-line-selectors-area">
                            <div class="list-line-time">
                                <select name="rest_start_hour[{{ $restsCount + 1 }}]" id="rest_start_hour_{{ $restsCount + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 23; $i++)
                                        <option value="{{ $i }}"
                                ...
                                :
                                <select name="rest_start_minute[{{ $restsCount + 1 }}]" id="rest_start_minute_{{ $restsCount + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 59; $i++)
                                        <option value="{{ $i }}"
                            ...
                            <p class="list-line-wave">～</p>
                            <div class="list-line-time">
                                <select name="rest_end_hour[{{ $restsCount + 1 }}]" id="rest_end_hour_{{ $restsCount + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 24; $i++)
                                        <option value="{{ $i }}"
                                ...
                                :
                                <select name="rest_end_minute[{{ $restsCount + 1 }}]" id="rest_end_minute_{{ $restsCount + 1 }}" class="list-line-selector">
                                    <option value="-1" selected>--</option>
                                    @for($i = 0; $i <= 59; $i++)
                                        <option value="{{ $i }}"
